...
pub struct TelemetryGuard {
    ...
    _metrics_controller: Option<SdkMeterProvider>,
}
...
) -> Option<tracing_opentelemetry::OpenTelemetryLayer<tracing_subscriber::Registry, trace::Tracer>>
{
    ...
    if config.use_xray_generator {
        trace_config = trace_config.with_id_generator(XrayIdGenerator::default());
    }
...
fn setup_metrics_pipeline(config: &config::LogTelemetry) -> Option<SdkMeterProvider> {
    //TODO: add histogram_buckets
